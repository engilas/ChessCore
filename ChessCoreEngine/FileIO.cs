    ...
    internal static class FileIO
    {
            ...
            ICollection<OpeningMove> gameBook, MoveContent bestMove)
        {
            try
            {
                ...
                if (currentBoard.RepeatedMove >= 3) currentBoard.StaleMate = true;
            }
            catch (Exception)
            {
            }
        ...
        internal static bool SaveGame(string filePath, Board chessBoard, ChessPieceColor whoseMove,
        ...
        internal static bool LoadGame(string filePath, ref Board chessBoard, ChessPieceColor whoseMove,
            ref Stack<MoveContent> moveHistory, ref List<OpeningMove> currentGameBook,
            ref List<OpeningMove> undoGameBook)
        {
