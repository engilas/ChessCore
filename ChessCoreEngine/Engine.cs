    ...
    public sealed class Engine
    {
        ...
        public Difficulty GameDifficulty
        {
            get
            {
                ...
                if (PlyDepthSearched == 5)
                    return Difficulty.Medium;
                if (PlyDepthSearched == 6)
                    return Difficulty.Hard;
                if (PlyDepthSearched == 7) return Difficulty.VeryHard;
        ...
        public bool RepeatedMove
        {
            get
            {
                if (ChessBoard.RepeatedMove >= 3) return true;
        ...
        private static bool CheckForMate(ChessPieceColor whosTurn, ref Board chessBoard)
        {
            ...
            if (chessBoard.BlackMate || chessBoard.WhiteMate || chessBoard.StaleMate) return true;
        ...
        public ChessPieceType GetPieceTypeAt(byte boardColumn, byte boardRow)
        {
            ...
            if (ChessBoard.Squares[index].Piece == null) return ChessPieceType.None;
        ...
        public ChessPieceColor GetPieceColorAt(byte boardColumn, byte boardRow)
        {
            ...
            if (ChessBoard.Squares[index].Piece == null) return ChessPieceColor.White;
        ...
        public bool IsValidMove(byte srcPosition, byte dstPosition)
        {
            ...
            if (dstPosition == ChessBoard.EnPassantPosition) return true;
        ...
        public bool IsGameOver()
        {
            ...
            if (ChessBoard.InsufficientMaterial) return true;
            return false;
        }
        ...
        {
            AiPonderMove(CancellationToken.None);
        }
            ...
            */
            ...
            if (FindPlayBookMove(ref bestMove, ChessBoard, OpeningBook) == false
                ...
                if (FindPlayBookMove(ref bestMove, ChessBoard, CurrentGameBook) == false ||
                    ChessBoard.HalfMoveClock > 90 || ChessBoard.RepeatedMove >= 2)
                    bestMove = Search.IterativeSearch(ChessBoard, PlyDepthSearched, ref NodesSearched,
                        ref NodesQuiessence, ref pvLine, ref PlyDepthReached, ref RootMovesSearched, CurrentGameBook,
                        ct);
            ...
            Board.MovePiece(ChessBoard, bestMove.MovingPiecePrimary.SrcPosition,
                bestMove.MovingPiecePrimary.DstPosition, ChessPieceType.Queen);
            ...
            if (CheckForMate(WhoseMove, ref ChessBoard))
            {
                ...
                if (ChessBoard.WhiteMate || ChessBoard.BlackMate) LastMove.PgnMove += "#";

                return;
            }

            if (ChessBoard.WhiteCheck || ChessBoard.BlackCheck) LastMove.PgnMove += "+";
